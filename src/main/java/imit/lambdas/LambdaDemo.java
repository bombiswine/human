...
public class LambdaDemo {
    ...
    final static Function<String, Integer> COUNT_WORDS_SEPARATED_WITH_COMA = s -> s.split(",").length;
    ...
    final static Function<? extends Human, ? extends Human> MAKE_ONE_YEAR_OLDER =
        h -> new Human(
            h.getFullName(),
